  ...
  return (
    <header className="flex h-12 shrink-0 items-center gap-3 border-b bg-background px-4">
      ...
      <button type="button" onClick={onOpenPalette}
        className="press mx-auto flex h-8 w-full max-w-md items-center gap-2 rounded-md border bg-card px-3 text-sm text-muted-foreground transition-colors hover:bg-accent">
